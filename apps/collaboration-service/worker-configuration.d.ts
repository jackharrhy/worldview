/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: a519afe7ccb6cea56e8de33f6bd92517)
// Runtime types generated with workerd@1.20260908.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
  WORLDVIEW_REALTIME_TICKET_SECRET: string;
  MAP_CELLS: DurableObjectNamespace<import('./src/index').MapCell>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'MapCell';
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'WORLDVIEW_REALTIME_TICKET_SECRET'>
  > {}
}
