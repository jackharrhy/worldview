/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 6a5ebf33b465a363ccf731ae5006d7d5)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
  WORLDVIEW_TICKET_SECRET: string;
  MAP_ROOMS: DurableObjectNamespace<import('./src/index').MapRoom>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'MapRoom';
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'WORLDVIEW_TICKET_SECRET'>> {}
}
