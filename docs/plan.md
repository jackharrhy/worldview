...
bounded level sample by game and excludes Quake pickup/prop BSPs from selectable fixtures while the
compatibility manifest retains them for parser evidence. The focused preset covers Thirty Flights
