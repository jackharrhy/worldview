...
routes, optimistic source-preserving autosave, named checkpoint storage, signed short-lived room
...
| 7. Hosted project foundation      | In progress | Newport deployment, 4orm identity, projects/maps, source autosave/checkpoints, signed hosted-room access, Artbin pinned mounts and cached WAD loading, and server-owned queued build records are delivered; membership/folder/history/build UI and production room-fleet hardening remain                                                                                                                                                                                                                 |
