...
- Quake/GoldSrc setup explicitly lists the included Worldview development texture pack; hosted map
  creation lists inherited project packs. The same packs must be available to compiled previews.
